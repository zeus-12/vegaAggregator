    ...
    async initialiseAcceleronPOS(licenseKey){
        try {
            const [{data:licenceObject},
                ...
                this.SettingsService.filterItemFromSettingsList("ACCELERATE_CONFIGURED_MACHINES", licenseKey),
                this.SettingsService.filterItemFromSettingsList("ACCELERATE_CONFIGURED_MACHINES", licenseKey),
                this.SettingsService.filterItemFromSettingsList("ACCELERATE_PERSONALIZATIONS", licenseKey),
                this.SettingsService.getSettingsById("ACCELERATE_BILL_LAYOUT"),
                this.SettingsService.filterItemFromSettingsList("ACCELERATE_SHORTCUT_KEYS", licenseKey),
                ...
                this.SettingsService.filterItemFromSettingsList("ACCELERATE_CONFIGURED_PRINTERS", licenseKey),
