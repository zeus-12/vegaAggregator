  ...
  paths: {
    ...
    "/managemenu/othermenumapping/{menuTypeCode}": {
      ...
      post: {
        ...
        description:
          "To create an item in a mapped menu against given menu type",
    ...
    "/summary/filterby/{filterName}": {
      get: {
        tags: ["sales-summary"],
        summary: "To get summary based on a filter",
        description:
          "To fetch sales summary based on different filters from a given start date to the given end date",
        operationId: "fetchSummaryByFilter",
        produces: ["application/json"],
        parameters: [
          {
            name: "filterName",
            in: "path",
            description:
              "filters can be - BILLING_MODE, PAYMENT_MODE, SESSIONS",
            required: true,
            type: "string",
          },
          {
    ...
    "/summary/filterby/{filterName}/splitby/{filterParameter}": {
      get: {
        tags: ["sales-summary"],
        summary: "To split the summary details by a filter parameter",
        description:
          "To view details of a summary based on a given filter parameter from a given start date to the given end date",
        operationId: "fetchSummaryByFilterDetailed",
        produces: ["application/json"],
        parameters: [
          {
            name: "filterName",
            in: "path",
            description: "filters can be - BILLING_MODE, PAYMENT_MODE",
            required: true,
            type: "string",
          },
          {
            ...
            in: "path",
            description:
              "filters parameters can be - for BILLING_MODE:- Dine In/Delivery/Takeaway, for PAYMENT_MODE:- CASH/PREPAID/CARDS/AMEX/PAYTM",
            required: true,
            type: "string",
          },
          {
